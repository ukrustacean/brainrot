...
function main() {
  program
      .name("brainrot")
      .description("Simple and minimalist Brainf*ck interpreter with very basic optimisation")
      .version("1.0.0")
      .argument("[FILE]", "path to the file to read Brainf*ck program from")
      .option("-e, --expr [EXPRESSION]", "evaluate a single-string program in Brainf*ck")
  ...
  if (filename && expression) {
    program.error("Both file and expression for evaluation were specified\n"
